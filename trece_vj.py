...
async def fetch_data(): # primjer jednostavne korutine koja simulira dohvaćanje podataka
    ...
    data = {'iznos': '3000', 'stanje': 'uspjesno'}
...
async def fetch_api_1():
    ...
    await asyncio.sleep(2)
    print('Podaci s API-ja 1 dohvaceni.')
    return {'api_1': 'uspjesno'}
async def fetch_api_2():
    print('Dohvacam podatke s API-ja 2...')
    await asyncio.sleep(4)
    print('Podaci s API-ja 2 dohvaceni.')
    return {'api_2': 'uspjesno'}

'''
'''
# čekamo dugo jer prvo čekamo api1, pa tek onda gre api2; nisu paralelni
